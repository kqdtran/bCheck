    ...
    <div class="container">
        ...
        <div class="row">
          <form id="enrollment-check" class="margin-base-vertical">
            ...
            <p>
              <textarea name="text" class="form-control" rows="2" placeholder="Enter Course Control Number(s), Each Separated by One Space"></textarea>
            </p>
            <p class="text-center">
        ...
        <div class="row">
          <form id="fetch-class" class="margin-base-vertical">
            <h1 class="margin-base-vertical">Find Open Classes</h1>
            <p class="text-center">
